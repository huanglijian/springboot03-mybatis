...
public class AdminProj {
    ...
    public String getProStuName() {
        return proStuName;
    }

    public void setProStuName(String proStuName) {
        this.proStuName = proStuName;
    }
    ...
    public String getProPromName() {
        return proPromName;
    }

    public void setProPromName(String proPromName) {
        this.proPromName = proPromName;
    }
