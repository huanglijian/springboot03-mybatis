...
//        String password = DESUtil.encodeBASE64(DESUtil.d3esEncode("111111"));
//        String decod = DESUtil.d3esDecode(DESUtil.decodeBASE64(password));
//        System.out.println(password);
//        System.out.println(decod);
        String now = DateUtils.format(new Date(), DateUtils.DATE_PATTERN);
        now = now.substring(5);
        String encode = DESUtil.encodeBASE64(now);
        String decode = DESUtil.decodeBASE64(encode);
