...
function change(v){
	...
	for(i=0;i<v;i++){
		str  =  str + ("_"+(document.getElementById(s[i]).selectedIndex-1));
	};
...
var str1 = document.getElementById("sp1").value;
var str2 = document.getElementById("sc").value;
var str3 = document.getElementById("sa").value;

var s=["s_province","s_city","s_county"];//三个select的name
var opt0 = [str1,str2,str3];//初始值
