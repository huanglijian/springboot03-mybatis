	...
	return function e(t, n, r) {
		...
		1: [function(e, t, n) {
			function r(e, t, n) {
				...
				return t = u(t) || 0, o(n) && (E = !!n.leading, T = "maxWait" in n, g = T ? c(u(n.maxWait) || 0, t) : g, L =
					"trailing" in n ? !!n.trailing : L), w.cancel = h, w.flush = m, w
			}
			var o = e("./isObject"),
				i = e("./now"),
				u = e("./toNumber"),
			...
			var i = function() {
				...
				c = function() {
					function e(t) {
						...
						o(this, e), this._name = this.constructor.name, this.element = this.validateSelector(t), this.helperClass =
							n, this.init()
					}
					return i(e, [{
						key: "init",
						...
						value: function() {
							var e = document.body;
							this.detectTouchOrSmallScreen() ? (this.element.pause(), e.classList.remove(this.helperClass)) : (this.element
								.play(), e.classList.add(this.helperClass))
						}
					}, {
						key: "validateSelector",
						value: function(e) {
							if ("undefined" == typeof e) throw new Error(this._name +
								" requires a video selector as first argument.");
							if (e = "string" == typeof e ? document.querySelector(e) : e, "video" !== e.nodeName.toLowerCase())
						...
						value: function() {
							var e = {
								touch: !!("ontouchstart" in window || window.navigator && window.navigator.msPointerEnabled && window
									.MSGesture || window.DocumentTouch && document instanceof DocumentTouch),
